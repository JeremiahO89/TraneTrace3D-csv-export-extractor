...
Put your ".csv" file in the same folder as the TrainConver.py file
Right Click on either the TrainConvertRooms.py or the TrainConvertZones.py (depending on what type of report you downloaded from Train Trace 3D) and open with Python 3.0 (or whatever version of Python you downloaded).
