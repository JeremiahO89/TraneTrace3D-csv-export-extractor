...
def spliceData(): # puts the data into a dictinary
    ...
    currentRoom = None
    for line in content:
        if "ROOM_" in line: # find the room names
            data = line.split(",")
            room = data[0][5:]
